...
export const Layout = ({ children }: LayoutProps) => {
  ...
  const menuItems = [
    ...
    { path: '/purchase-requests', label: 'Purchase Requests', icon: '📝', roles: ['Admin', 'OU', 'Accountant', 'ViewOnly', 'SM'] },
    { path: '/procurement', label: 'Procurement', icon: '📋', roles: ['Admin', 'Procurement', 'ViewOnly'] },
    { path: '/floating-cash', label: 'Floating Cash', icon: '💵', roles: ['Admin', 'ViewOnly'] },
    { path: '/admin/fuel-buying-rates', label: 'Fuel Buying Rates', icon: '⛽', roles: ['Admin', 'ViewOnly'] },
    { path: '/admin/transporters', label: 'Transporters', icon: '🚚', roles: ['Admin', 'ViewOnly'] },
