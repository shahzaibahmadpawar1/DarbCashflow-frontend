    ...
    <div class="header">
        ...
        <div class="info-grid">
            ...
            <div class="info-item">
                ...
                <span class="info-value">${dateFilterType === 'single' ? `Date: ${singleDate}` : `Period: ${startDate} to ${endDate}`}</span>
            </div>
            ` : ''}
            <div class="info-item">
            ...
            <div className="bg-white rounded-xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col">
                        ...
                        {dateFilterType === 'single' && (
                            <div className="flex items-center gap-2">
                                ...
                                <input
                                    ...
                                    className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white shadow-sm"
                                />
                            </div>
                        )}
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    {loading ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-gray-500">No delivery records found for the selected period</p>
                        </div>
                    ) : (
                ...
                <div className="p-4 border-t border-gray-200 bg-gray-50">
                    <div className="flex justify-end gap-3">
                        <button
                            ...
                            className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-lg"
                        >
